...
- **Copy voice — "we" and "our team", settled Sept 9, 2026.** Kyle's call, applies everywhere going forward. Do not write the site in first person or sign it with his name. The line to hold is voice vs. headcount: "we"/"our team" is how any company talks about itself and claims nothing about size, but never state or imply a team size, name staff who don't exist, or invent departments, offices, or roles. "Our team reads every message" — fine. "Our team of analysts" — not.
